...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yn,depthTest:!1,depthWrite:!1})}function Kl(){return new Ln({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Oa(),fragmentShader:`
		...
		`,blending:Yn,depthTest:!1,depthWrite:!1})}function Zl(){return new Ln({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Oa(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Zm(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===qc?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Ih?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Mn&&(t="SHADOWMAP_TYPE_VSM"),t}function Jm(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case $i:case Ki:t="ENVMAP_TYPE_CUBE";break;case Fs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Qm(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Ki:t="ENVMAP_MODE_REFRACTION";break}return t}function t1(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case jc:t="ENVMAP_BLENDING_MULTIPLY";break;case Qh:t="ENVMAP_BLENDING_MIX";break;case td:t="ENVMAP_BLENDING_ADD";break}return t}function e1(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function n1(n,t,e,i){const r=n.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Zm(e),c=Jm(e),u=Qm(e),d=t1(e),p=e1(e),m=Gm(e),_=Wm(s),b=r.createProgram();let f,h,y=e.glslVersion?"#version "+e.glslVersion+`
...
}`;function b1(n,t,e){let i=new gu;const r=new Dt,s=new Dt,o=new he,a=new v1({depthPacking:ud}),l=new g1,c={},u=e.maxTextureSize,d={[Jn]:Le,[Le]:Jn,[wn]:wn},p=new Ln({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Dt},radius:{value:4}},vertexShader:_1,fragmentShader:x1}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const _=new wi;_.setAttribute("position",new an(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const b=new sn(_,p),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=qc;let h=this.type;this.render=function(L,C,U){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||L.length===0)return;const M=n.getRenderTarget(),x=n.getActiveCubeFace(),T=n.getActiveMipmapLevel(),G=n.state;G.setBlending(Yn),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const V=h!==Mn&&this.type===Mn,Y=h===Mn&&this.type!==Mn;for(let $=0,X=L.length;$<X;$++){const Z=L[$],k=Z.shadow;if(k===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;r.copy(k.mapSize);const it=k.getFrameExtents();if(r.multiply(it),s.copy(k.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/it.x),r.x=s.x*it.x,k.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/it.y),r.y=s.y*it.y,k.mapSize.y=s.y)),k.map===null||V===!0||Y===!0){const xt=this.type!==Mn?{minFilter:en,magFilter:en}:{};k.map!==null&&k.map.dispose(),k.map=new Qn(r.x,r.y,xt),k.map.texture.name=Z.name+".shadowMap",k.camera.updateProjectionMatrix()}n.setRenderTarget(k.map),n.clear();const ct=k.getViewportCount();for(let xt=0;xt<ct;xt++){const It=k.getViewport(xt);o.set(s.x*It.x,s.y*It.y,s.x*It.z,s.y*It.w),G.viewport(o),k.updateMatrices(Z,xt),i=k.getFrustum(),E(C,U,k.camera,Z,this.type)}k.isPointLightShadow!==!0&&this.type===Mn&&y(k,U),k.needsUpdate=!1}h=this.type,f.needsUpdate=!1,n.setRenderTarget(M,x,T)};function y(L,C){const U=t.update(b);p.defines.VSM_SAMPLES!==L.blurSamples&&(p.defines.VSM_SAMPLES=L.blurSamples,m.defines.VSM_SAMPLES=L.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),L.mapPass===null&&(L.mapPass=new Qn(r.x,r.y)),p.uniforms.shadow_pass.value=L.map.texture,p.uniforms.resolution.value=L.mapSize,p.uniforms.radius.value=L.radius,n.setRenderTarget(L.mapPass),n.clear(),n.renderBufferDirect(C,null,U,p,b,null),m.uniforms.shadow_pass.value=L.mapPass.texture,m.uniforms.resolution.value=L.mapSize,m.uniforms.radius.value=L.radius,n.setRenderTarget(L.map),n.clear(),n.renderBufferDirect(C,null,U,m,b,null)}function S(L,C,U,M){let x=null;const T=U.isPointLight===!0?L.customDistanceMaterial:L.customDepthMaterial;if(T!==void 0)x=T;else if(x=U.isPointLight===!0?l:a,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const G=x.uuid,V=C.uuid;let Y=c[G];Y===void 0&&(Y={},c[G]=Y);let $=Y[V];$===void 0&&($=x.clone(),Y[V]=$,C.addEventListener("dispose",B)),x=$}if(x.visible=C.visible,x.wireframe=C.wireframe,M===Mn?x.side=C.shadowSide!==null?C.shadowSide:C.side:x.side=C.shadowSide!==null?C.shadowSide:d[C.side],x.alphaMap=C.alphaMap,x.alphaTest=C.alphaTest,x.map=C.map,x.clipShadows=C.clipShadows,x.clippingPlanes=C.clippingPlanes,x.clipIntersection=C.clipIntersection,x.displacementMap=C.displacementMap,x.displacementScale=C.displacementScale,x.displacementBias=C.displacementBias,x.wireframeLinewidth=C.wireframeLinewidth,x.linewidth=C.linewidth,U.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const G=n.properties.get(x);G.light=U}return x}function E(L,C,U,M,x){if(L.visible===!1)return;if(L.layers.test(C.layers)&&(L.isMesh||L.isLine||L.isPoints)&&(L.castShadow||L.receiveShadow&&x===Mn)&&(!L.frustumCulled||i.intersectsObject(L))){L.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,L.matrixWorld);const V=t.update(L),Y=L.material;if(Array.isArray(Y)){const $=V.groups;for(let X=0,Z=$.length;X<Z;X++){const k=$[X],it=Y[k.materialIndex];if(it&&it.visible){const ct=S(L,it,M,x);L.onBeforeShadow(n,L,C,U,V,ct,k),n.renderBufferDirect(U,null,V,ct,L,k),L.onAfterShadow(n,L,C,U,V,ct,k)}}}else if(Y.visible){const $=S(L,Y,M,x);L.onBeforeShadow(n,L,C,U,V,$,null),n.renderBufferDirect(U,null,V,$,L,null),L.onAfterShadow(n,L,C,U,V,$,null)}}const G=L.children;for(let V=0,Y=G.length;V<Y;V++)E(G[V],C,U,M,x)}function B(L){L.target.removeEventListener("dispose",B);for(const U in c){const M=c[U],x=L.target.uuid;x in M&&(M[x].dispose(),delete M[x])}}}const M1={[Fo]:No,[Oo]:zo,[Bo]:ko,[Yi]:Vo,[No]:Fo,[zo]:Oo,[ko]:Bo,[Vo]:Yi};function w1(n,t){function e(){let A=!1;const nt=new he;let z=null;const j=new he(0,0,0,0);return{setMask:function(lt){z!==lt&&!A&&(n.colorMask(lt,lt,lt,lt),z=lt)},setLocked:function(lt){A=lt},setClear:function(lt,ot,Tt,le,xe){xe===!0&&(lt*=le,ot*=le,Tt*=le),nt.set(lt,ot,Tt,le),j.equals(nt)===!1&&(n.clearColor(lt,ot,Tt,le),j.copy(nt))},reset:function(){A=!1,z=null,j.set(-1,0,0,0)}}}function i(){let A=!1,nt=!1,z=null,j=null,lt=null;return{setReversed:function(ot){if(nt!==ot){const Tt=t.get("EXT_clip_control");nt?Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.ZERO_TO_ONE_EXT):Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.NEGATIVE_ONE_TO_ONE_EXT);const le=lt;lt=null,this.setClear(le)}nt=ot},getReversed:function(){return nt},setTest:function(ot){ot?rt(n.DEPTH_TEST):Et(n.DEPTH_TEST)},setMask:function(ot){z!==ot&&!A&&(n.depthMask(ot),z=ot)},setFunc:function(ot){if(nt&&(ot=M1[ot]),j!==ot){switch(ot){case Fo:n.depthFunc(n.NEVER);break;case No:n.depthFunc(n.ALWAYS);break;case Oo:n.depthFunc(n.LESS);break;case Yi:n.depthFunc(n.LEQUAL);break;case Bo:n.depthFunc(n.EQUAL);break;case Vo:n.depthFunc(n.GEQUAL);break;case zo:n.depthFunc(n.GREATER);break;case ko:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}j=ot}},setLocked:function(ot){A=ot},setClear:function(ot){lt!==ot&&(nt&&(ot=1-ot),n.clearDepth(ot),lt=ot)},reset:function(){A=!1,z=null,j=null,lt=null,nt=!1}}}function r(){let A=!1,nt=null,z=null,j=null,lt=null,ot=null,Tt=null,le=null,xe=null;return{setTest:function($t){A||($t?rt(n.STENCIL_TEST):Et(n.STENCIL_TEST))},setMask:function($t){nt!==$t&&!A&&(n.stencilMask($t),nt=$t)},setFunc:function($t,je,hn){(z!==$t||j!==je||lt!==hn)&&(n.stencilFunc($t,je,hn),z=$t,j=je,lt=hn)},setOp:function($t,je,hn){(ot!==$t||Tt!==je||le!==hn)&&(n.stencilOp($t,je,hn),ot=$t,Tt=je,le=hn)},setLocked:function($t){A=$t},setClear:function($t){xe!==$t&&(n.clearStencil($t),xe=$t)},reset:function(){A=!1,nt=null,z=null,j=null,lt=null,ot=null,Tt=null,le=null,xe=null}}}const s=new e,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let u={},d={},p=new WeakMap,m=[],_=null,b=!1,f=null,h=null,y=null,S=null,E=null,B=null,L=null,C=new Zt(0,0,0),U=0,M=!1,x=null,T=null,G=null,V=null,Y=null;const $=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,Z=0;const k=n.getParameter(n.VERSION);k.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(k)[1]),X=Z>=1):k.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(k)[1]),X=Z>=2);let it=null,ct={};const xt=n.getParameter(n.SCISSOR_BOX),It=n.getParameter(n.VIEWPORT),Jt=new he().fromArray(xt),W=new he().fromArray(It);function tt(A,nt,z,j){const lt=new Uint8Array(4),ot=n.createTexture();n.bindTexture(A,ot),n.texParameteri(A,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(A,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Tt=0;Tt<z;Tt++)A===n.TEXTURE_3D||A===n.TEXTURE_2D_ARRAY?n.texImage3D(nt,0,n.RGBA,1,1,j,0,n.RGBA,n.UNSIGNED_BYTE,lt):n.texImage2D(nt+Tt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,lt);return ot}const vt={};vt[n.TEXTURE_2D]=tt(n.TEXTURE_2D,n.TEXTURE_2D,1),vt[n.TEXTURE_CUBE_MAP]=tt(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),vt[n.TEXTURE_2D_ARRAY]=tt(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),vt[n.TEXTURE_3D]=tt(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),rt(n.DEPTH_TEST),o.setFunc(Yi),Ot(!1),Bt(xl),rt(n.CULL_FACE),D(Yn);function rt(A){u[A]!==!0&&(n.enable(A),u[A]=!0)}function Et(A){u[A]!==!1&&(n.disable(A),u[A]=!1)}function Ct(A,nt){return d[A]!==nt?(n.bindFramebuffer(A,nt),d[A]=nt,A===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=nt),A===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=nt),!0):!1}function Ft(A,nt){let z=m,j=!1;if(A){z=p.get(nt),z===void 0&&(z=[],p.set(nt,z));const lt=A.textures;if(z.length!==lt.length||z[0]!==n.COLOR_ATTACHMENT0){for(let ot=0,Tt=lt.length;ot<Tt;ot++)z[ot]=n.COLOR_ATTACHMENT0+ot;z.length=lt.length,j=!0}}else z[0]!==n.BACK&&(z[0]=n.BACK,j=!0);j&&n.drawBuffers(z)}function oe(A){return _!==A?(n.useProgram(A),_=A,!0):!1}const zt={[hi]:n.FUNC_ADD,[Nh]:n.FUNC_SUBTRACT,[Oh]:n.FUNC_REVERSE_SUBTRACT};zt[Bh]=n.MIN,zt[Vh]=n.MAX;const ue={[zh]:n.ZERO,[kh]:n.ONE,[Hh]:n.SRC_COLOR,[Uo]:n.SRC_ALPHA,[Yh]:n.SRC_ALPHA_SATURATE,[qh]:n.DST_COLOR,[Wh]:n.DST_ALPHA,[Gh]:n.ONE_MINUS_SRC_COLOR,[Io]:n.ONE_MINUS_SRC_ALPHA,[jh]:n.ONE_MINUS_DST_COLOR,[Xh]:n.ONE_MINUS_DST_ALPHA,[$h]:n.CONSTANT_COLOR,[Kh]:n.ONE_MINUS_CONSTANT_COLOR,[Zh]:n.CONSTANT_ALPHA,[Jh]:n.ONE_MINUS_CONSTANT_ALPHA};function D(A,nt,z,j,lt,ot,Tt,le,xe,$t){if(A===Yn){b===!0&&(Et(n.BLEND),b=!1);return}if(b===!1&&(rt(n.BLEND),b=!0),A!==Fh){if(A!==f||$t!==M){if((h!==hi||E!==hi)&&(n.blendEquation(n.FUNC_ADD),h=hi,E=hi),$t)switch(A){case Gi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case bl:n.blendFunc(n.ONE,n.ONE);break;case Ml:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case wl:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",A);break}else switch(A){case Gi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case bl:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Ml:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case wl:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",A);break}y=null,S=null,B=null,L=null,C.set(0,0,0),U=0,f=A,M=$t}return}lt=lt||nt,ot=ot||z,Tt=Tt||j,(nt!==h||lt!==E)&&(n.blendEquationSeparate(zt[nt],zt[lt]),h=nt,E=lt),(z!==y||j!==S||ot!==B||Tt!==L)&&(n.blendFuncSeparate(ue[z],ue[j],ue[ot],ue[Tt]),y=z,S=j,B=ot,L=Tt),(le.equals(C)===!1||xe!==U)&&(n.blendColor(le.r,le.g,le.b,xe),C.copy(le),U=xe),f=A,M=!1}function ze(A,nt){A.side===wn?Et(n.CULL_FACE):rt(n.CULL_FACE);let z=A.side===Le;nt&&(z=!z),Ot(z),A.blending===Gi&&A.transparent===!1?D(Yn):D(A.blending,A.blendEquation,A.blendSrc,A.blendDst,A.blendEquationAlpha,A.blendSrcAlpha,A.blendDstAlpha,A.blendColor,A.blendAlpha,A.premultipliedAlpha),o.setFunc(A.depthFunc),o.setTest(A.depthTest),o.setMask(A.depthWrite),s.setMask(A.colorWrite);const j=A.stencilWrite;a.setTest(j),j&&(a.setMask(A.stencilWriteMask),a.setFunc(A.stencilFunc,A.stencilRef,A.stencilFuncMask),a.setOp(A.stencilFail,A.stencilZFail,A.stencilZPass)),ne(A.polygonOffset,A.polygonOffsetFactor,A.polygonOffsetUnits),A.alphaToCoverage===!0?rt(n.SAMPLE_ALPHA_TO_COVERAGE):Et(n.SAMPLE_ALPHA_TO_COVERAGE)}function Ot(A){x!==A&&(A?n.frontFace(n.CW):n.frontFace(n.CCW),x=A)}function Bt(A){A!==Dh?(rt(n.CULL_FACE),A!==T&&(A===xl?n.cullFace(n.BACK):A===Uh?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Et(n.CULL_FACE),T=A}function Mt(A){A!==G&&(X&&n.lineWidth(A),G=A)}function ne(A,nt,z){A?(rt(n.POLYGON_OFFSET_FILL),(V!==nt||Y!==z)&&(n.polygonOffset(nt,z),V=nt,Y=z)):Et(n.POLYGON_OFFSET_FILL)}function bt(A){A?rt(n.SCISSOR_TEST):Et(n.SCISSOR_TEST)}function w(A){A===void 0&&(A=n.TEXTURE0+$-1),it!==A&&(n.activeTexture(A),it=A)}function v(A,nt,z){z===void 0&&(it===null?z=n.TEXTURE0+$-1:z=it);let j=ct[z];j===void 0&&(j={type:void 0,texture:void 0},ct[z]=j),(j.type!==A||j.texture!==nt)&&(it!==z&&(n.activeTexture(z),it=z),n.bindTexture(A,nt||vt[A]),j.type=A,j.texture=nt)}function I(){const A=ct[it];A!==void 0&&A.type!==void 0&&(n.bindTexture(A.type,null),A.type=void 0,A.texture=void 0)}function q(){try{n.compressedTexImage2D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function K(){try{n.compressedTexImage3D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function H(){try{n.texSubImage2D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function gt(){try{n.texSubImage3D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function st(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function ut(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function kt(){try{n.texStorage2D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function J(){try{n.texStorage3D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function ht(){try{n.texImage2D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function wt(){try{n.texImage3D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function St(A){Jt.equals(A)===!1&&(n.scissor(A.x,A.y,A.z,A.w),Jt.copy(A))}function dt(A){W.equals(A)===!1&&(n.viewport(A.x,A.y,A.z,A.w),W.copy(A))}function Vt(A,nt){let z=c.get(nt);z===void 0&&(z=new WeakMap,c.set(nt,z));let j=z.get(A);j===void 0&&(j=n.getUniformBlockIndex(nt,A.name),z.set(A,j))}function Rt(A,nt){const j=c.get(nt).get(A);l.get(nt)!==j&&(n.uniformBlockBinding(nt,j,A.__bindingPointIndex),l.set(nt,j))}function Qt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},it=null,ct={},d={},p=new WeakMap,m=[],_=null,b=!1,f=null,h=null,y=null,S=null,E=null,B=null,L=null,C=new Zt(0,0,0),U=0,M=!1,x=null,T=null,G=null,V=null,Y=null,Jt.set(0,0,n.canvas.width,n.canvas.height),W.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:rt,disable:Et,bindFramebuffer:Ct,drawBuffers:Ft,useProgram:oe,setBlending:D,setMaterial:ze,setFlipSided:Ot,setCullFace:Bt,setLineWidth:Mt,setPolygonOffset:ne,setScissorTest:bt,activeTexture:w,bindTexture:v,unbindTexture:I,compressedTexImage2D:q,compressedTexImage3D:K,texImage2D:ht,texImage3D:wt,updateUBOMapping:Vt,uniformBlockBinding:Rt,texStorage2D:kt,texStorage3D:J,texSubImage2D:H,texSubImage3D:gt,compressedTexSubImage2D:st,compressedTexSubImage3D:ut,scissor:St,viewport:dt,reset:Qt}}function mc(n,t,e,i){const r=E1(i);switch(e){case Jc:return n*t;case tu:return n*t;case eu:return n*t*2;case nu:return n*t/r.components*r.byteLength;case Ua:return n*t/r.components*r.byteLength;case iu:return n*t*2/r.components*r.byteLength;case Ia:return n*t*2/r.components*r.byteLength;case Qc:return n*t*3/r.components*r.byteLength;case Xe:return n*t*4/r.components*r.byteLength;case Fa:return n*t*4/r.components*r.byteLength;case _s:case xs:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*8;case bs:case Ms:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case jo:case $o:return Math.max(n,16)*Math.max(t,8)/4;case qo:case Yo:return Math.max(n,8)*Math.max(t,8)/2;case Ko:case Zo:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*8;case Jo:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case Qo:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case ta:return Math.floor((n+4)/5)*Math.floor((t+3)/4)*16;case ea:return Math.floor((n+4)/5)*Math.floor((t+4)/5)*16;case na:return Math.floor((n+5)/6)*Math.floor((t+4)/5)*16;case ia:return Math.floor((n+5)/6)*Math.floor((t+5)/6)*16;case ra:return Math.floor((n+7)/8)*Math.floor((t+4)/5)*16;case sa:return Math.floor((n+7)/8)*Math.floor((t+5)/6)*16;case oa:return Math.floor((n+7)/8)*Math.floor((t+7)/8)*16;case aa:return Math.floor((n+9)/10)*Math.floor((t+4)/5)*16;case la:return Math.floor((n+9)/10)*Math.floor((t+5)/6)*16;case ca:return Math.floor((n+9)/10)*Math.floor((t+7)/8)*16;case ua:return Math.floor((n+9)/10)*Math.floor((t+9)/10)*16;case ha:return Math.floor((n+11)/12)*Math.floor((t+9)/10)*16;case da:return Math.floor((n+11)/12)*Math.floor((t+11)/12)*16;case ws:case pa:case fa:return Math.ceil(n/4)*Math.ceil(t/4)*16;case ru:case ma:return Math.ceil(n/4)*Math.ceil(t/4)*8;case va:case ga:return Math.ceil(n/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function E1(n){switch(n){case ln:case $c:return{byteLength:1,components:1};case Sr:case Kc:case er:return{byteLength:2,components:1};case La:case Da:return{byteLength:2,components:4};case gi:case Ra:case En:return{byteLength:4,components:1};case Zc:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function S1(n,t,e,i,r,s,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Dt,u=new WeakMap;let d;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(w,v){return m?new OffscreenCanvas(w,v):Ts("canvas")}function b(w,v,I){let q=1;const K=bt(w);if((K.width>I||K.height>I)&&(q=I/Math.max(K.width,K.height)),q<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const H=Math.floor(q*K.width),gt=Math.floor(q*K.height);d===void 0&&(d=_(H,gt));const st=v?_(H,gt):d;return st.width=H,st.height=gt,st.getContext("2d").drawImage(w,0,0,H,gt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+H+"x"+gt+")."),st}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),w;return w}function f(w){return w.generateMipmaps}function h(w){n.generateMipmap(w)}function y(w){return w.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?n.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function S(w,v,I,q,K=!1){if(w!==null){if(n[w]!==void 0)return n[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let H=v;if(v===n.RED&&(I===n.FLOAT&&(H=n.R32F),I===n.HALF_FLOAT&&(H=n.R16F),I===n.UNSIGNED_BYTE&&(H=n.R8)),v===n.RED_INTEGER&&(I===n.UNSIGNED_BYTE&&(H=n.R8UI),I===n.UNSIGNED_SHORT&&(H=n.R16UI),I===n.UNSIGNED_INT&&(H=n.R32UI),I===n.BYTE&&(H=n.R8I),I===n.SHORT&&(H=n.R16I),I===n.INT&&(H=n.R32I)),v===n.RG&&(I===n.FLOAT&&(H=n.RG32F),I===n.HALF_FLOAT&&(H=n.RG16F),I===n.UNSIGNED_BYTE&&(H=n.RG8)),v===n.RG_INTEGER&&(I===n.UNSIGNED_BYTE&&(H=n.RG8UI),I===n.UNSIGNED_SHORT&&(H=n.RG16UI),I===n.UNSIGNED_INT&&(H=n.RG32UI),I===n.BYTE&&(H=n.RG8I),I===n.SHORT&&(H=n.RG16I),I===n.INT&&(H=n.RG32I)),v===n.RGB_INTEGER&&(I===n.UNSIGNED_BYTE&&(H=n.RGB8UI),I===n.UNSIGNED_SHORT&&(H=n.RGB16UI),I===n.UNSIGNED_INT&&(H=n.RGB32UI),I===n.BYTE&&(H=n.RGB8I),I===n.SHORT&&(H=n.RGB16I),I===n.INT&&(H=n.RGB32I)),v===n.RGBA_INTEGER&&(I===n.UNSIGNED_BYTE&&(H=n.RGBA8UI),I===n.UNSIGNED_SHORT&&(H=n.RGBA16UI),I===n.UNSIGNED_INT&&(H=n.RGBA32UI),I===n.BYTE&&(H=n.RGBA8I),I===n.SHORT&&(H=n.RGBA16I),I===n.INT&&(H=n.RGBA32I)),v===n.RGB&&I===n.UNSIGNED_INT_5_9_9_9_REV&&(H=n.RGB9_E5),v===n.RGBA){const gt=K?Ns:Ht.getTransfer(q);I===n.FLOAT&&(H=n.RGBA32F),I===n.HALF_FLOAT&&(H=n.RGBA16F),I===n.UNSIGNED_BYTE&&(H=gt===Kt?n.SRGB8_ALPHA8:n.RGBA8),I===n.UNSIGNED_SHORT_4_4_4_4&&(H=n.RGBA4),I===n.UNSIGNED_SHORT_5_5_5_1&&(H=n.RGB5_A1)}return(H===n.R16F||H===n.R32F||H===n.RG16F||H===n.RG32F||H===n.RGBA16F||H===n.RGBA32F)&&t.get("EXT_color_buffer_float"),H}function E(w,v){let I;return w?v===null||v===gi||v===Zi?I=n.DEPTH24_STENCIL8:v===En?I=n.DEPTH32F_STENCIL8:v===Sr&&(I=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===gi||v===Zi?I=n.DEPTH_COMPONENT24:v===En?I=n.DEPTH_COMPONENT32F:v===Sr&&(I=n.DEPTH_COMPONENT16),I}function B(w,v){return f(w)===!0||w.isFramebufferTexture&&w.minFilter!==en&&w.minFilter!==Ne?Math.log2(Math.max(v.width,v.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?v.mipmaps.length:1}function L(w){const v=w.target;v.removeEventListener("dispose",L),U(v),v.isVideoTexture&&u.delete(v)}function C(w){const v=w.target;v.removeEventListener("dispose",C),x(v)}function U(w){const v=i.get(w);if(v.__webglInit===void 0)return;const I=w.source,q=p.get(I);if(q){const K=q[v.__cacheKey];K.usedTimes--,K.usedTimes===0&&M(w),Object.keys(q).length===0&&p.delete(I)}i.remove(w)}function M(w){const v=i.get(w);n.deleteTexture(v.__webglTexture);const I=w.source,q=p.get(I);delete q[v.__cacheKey],o.memory.textures--}function x(w){const v=i.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),i.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(v.__webglFramebuffer[q]))for(let K=0;K<v.__webglFramebuffer[q].length;K++)n.deleteFramebuffer(v.__webglFramebuffer[q][K]);else n.deleteFramebuffer(v.__webglFramebuffer[q]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[q])}else{if(Array.isArray(v.__webglFramebuffer))for(let q=0;q<v.__webglFramebuffer.length;q++)n.deleteFramebuffer(v.__webglFramebuffer[q]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let q=0;q<v.__webglColorRenderbuffer.length;q++)v.__webglColorRenderbuffer[q]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[q]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const I=w.textures;for(let q=0,K=I.length;q<K;q++){const H=i.get(I[q]);H.__webglTexture&&(n.deleteTexture(H.__webglTexture),o.memory.textures--),i.remove(I[q])}i.remove(w)}let T=0;function G(){T=0}function V(){const w=T;return w>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),T+=1,w}function Y(w){const v=[];return v.push(w.wrapS),v.push(w.wrapT),v.push(w.wrapR||0),v.push(w.magFilter),v.push(w.minFilter),v.push(w.anisotropy),v.push(w.internalFormat),v.push(w.format),v.push(w.type),v.push(w.generateMipmaps),v.push(w.premultiplyAlpha),v.push(w.flipY),v.push(w.unpackAlignment),v.push(w.colorSpace),v.join()}function $(w,v){const I=i.get(w);if(w.isVideoTexture&&Mt(w),w.isRenderTargetTexture===!1&&w.version>0&&I.__version!==w.version){const q=w.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{W(I,w,v);return}}e.bindTexture(n.TEXTURE_2D,I.__webglTexture,n.TEXTURE0+v)}function X(w,v){const I=i.get(w);if(w.version>0&&I.__version!==w.version){W(I,w,v);return}e.bindTexture(n.TEXTURE_2D_ARRAY,I.__webglTexture,n.TEXTURE0+v)}function Z(w,v){const I=i.get(w);if(w.version>0&&I.__version!==w.version){W(I,w,v);return}e.bindTexture(n.TEXTURE_3D,I.__webglTexture,n.TEXTURE0+v)}function k(w,v){const I=i.get(w);if(w.version>0&&I.__version!==w.version){tt(I,w,v);return}e.bindTexture(n.TEXTURE_CUBE_MAP,I.__webglTexture,n.TEXTURE0+v)}const it={[Wo]:n.REPEAT,[pi]:n.CLAMP_TO_EDGE,[Xo]:n.MIRRORED_REPEAT},ct={[en]:n.NEAREST,[ld]:n.NEAREST_MIPMAP_NEAREST,[Yr]:n.NEAREST_MIPMAP_LINEAR,[Ne]:n.LINEAR,[Ws]:n.LINEAR_MIPMAP_NEAREST,[fi]:n.LINEAR_MIPMAP_LINEAR},xt={[pd]:n.NEVER,[xd]:n.ALWAYS,[fd]:n.LESS,[su]:n.LEQUAL,[md]:n.EQUAL,[_d]:n.GEQUAL,[vd]:n.GREATER,[gd]:n.NOTEQUAL};function It(w,v){if(v.type===En&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===Ne||v.magFilter===Ws||v.magFilter===Yr||v.magFilter===fi||v.minFilter===Ne||v.minFilter===Ws||v.minFilter===Yr||v.minFilter===fi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(w,n.TEXTURE_WRAP_S,it[v.wrapS]),n.texParameteri(w,n.TEXTURE_WRAP_T,it[v.wrapT]),(w===n.TEXTURE_3D||w===n.TEXTURE_2D_ARRAY)&&n.texParameteri(w,n.TEXTURE_WRAP_R,it[v.wrapR]),n.texParameteri(w,n.TEXTURE_MAG_FILTER,ct[v.magFilter]),n.texParameteri(w,n.TEXTURE_MIN_FILTER,ct[v.minFilter]),v.compareFunction&&(n.texParameteri(w,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(w,n.TEXTURE_COMPARE_FUNC,xt[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===en||v.minFilter!==Yr&&v.minFilter!==fi||v.type===En&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const I=t.get("EXT_texture_filter_anisotropic");n.texParameterf(w,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function Jt(w,v){let I=!1;w.__webglInit===void 0&&(w.__webglInit=!0,v.addEventListener("dispose",L));const q=v.source;let K=p.get(q);K===void 0&&(K={},p.set(q,K));const H=Y(v);if(H!==w.__cacheKey){K[H]===void 0&&(K[H]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,I=!0),K[H].usedTimes++;const gt=K[w.__cacheKey];gt!==void 0&&(K[w.__cacheKey].usedTimes--,gt.usedTimes===0&&M(v)),w.__cacheKey=H,w.__webglTexture=K[H].texture}return I}function W(w,v,I){let q=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(q=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(q=n.TEXTURE_3D);const K=Jt(w,v),H=v.source;e.bindTexture(q,w.__webglTexture,n.TEXTURE0+I);const gt=i.get(H);if(H.version!==gt.__version||K===!0){e.activeTexture(n.TEXTURE0+I);const st=Ht.getPrimaries(Ht.workingColorSpace),ut=v.colorSpace===qn?null:Ht.getPrimaries(v.colorSpace),kt=v.colorSpace===qn||st===ut?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,kt);let J=b(v.image,!1,r.maxTextureSize);J=ne(v,J);const ht=s.convert(v.format,v.colorSpace),wt=s.convert(v.type);let St=S(v.internalFormat,ht,wt,v.colorSpace,v.isVideoTexture);It(q,v);let dt;const Vt=v.mipmaps,Rt=v.isVideoTexture!==!0,Qt=gt.__version===void 0||K===!0,A=H.dataReady,nt=B(v,J);if(v.isDepthTexture)St=E(v.format===Ji,v.type),Qt&&(Rt?e.texStorage2D(n.TEXTURE_2D,1,St,J.width,J.height):e.texImage2D(n.TEXTURE_2D,0,St,J.width,J.height,0,ht,wt,null));else if(v.isDataTexture)if(Vt.length>0){Rt&&Qt&&e.texStorage2D(n.TEXTURE_2D,nt,St,Vt[0].width,Vt[0].height);for(let z=0,j=Vt.length;z<j;z++)dt=Vt[z],Rt?A&&e.texSubImage2D(n.TEXTURE_2D,z,0,0,dt.width,dt.height,ht,wt,dt.data):e.texImage2D(n.TEXTURE_2D,z,St,dt.width,dt.height,0,ht,wt,dt.data);v.generateMipmaps=!1}else Rt?(Qt&&e.texStorage2D(n.TEXTURE_2D,nt,St,J.width,J.height),A&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,J.width,J.height,ht,wt,J.data)):e.texImage2D(n.TEXTURE_2D,0,St,J.width,J.height,0,ht,wt,J.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Rt&&Qt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,nt,St,Vt[0].width,Vt[0].height,J.depth);for(let z=0,j=Vt.length;z<j;z++)if(dt=Vt[z],v.format!==Xe)if(ht!==null)if(Rt){if(A)if(v.layerUpdates.size>0){const lt=mc(dt.width,dt.height,v.format,v.type);for(const ot of v.layerUpdates){const Tt=dt.data.subarray(ot*lt/dt.data.BYTES_PER_ELEMENT,(ot+1)*lt/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,z,0,0,ot,dt.width,dt.height,1,ht,Tt)}v.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,z,0,0,0,dt.width,dt.height,J.depth,ht,dt.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,z,St,dt.width,dt.height,J.depth,0,dt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Rt?A&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,z,0,0,0,dt.width,dt.height,J.depth,ht,wt,dt.data):e.texImage3D(n.TEXTURE_2D_ARRAY,z,St,dt.width,dt.height,J.depth,0,ht,wt,dt.data)}else{Rt&&Qt&&e.texStorage2D(n.TEXTURE_2D,nt,St,Vt[0].width,Vt[0].height);for(let z=0,j=Vt.length;z<j;z++)dt=Vt[z],v.format!==Xe?ht!==null?Rt?A&&e.compressedTexSubImage2D(n.TEXTURE_2D,z,0,0,dt.width,dt.height,ht,dt.data):e.compressedTexImage2D(n.TEXTURE_2D,z,St,dt.width,dt.height,0,dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Rt?A&&e.texSubImage2D(n.TEXTURE_2D,z,0,0,dt.width,dt.height,ht,wt,dt.data):e.texImage2D(n.TEXTURE_2D,z,St,dt.width,dt.height,0,ht,wt,dt.data)}else if(v.isDataArrayTexture)if(Rt){if(Qt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,nt,St,J.width,J.height,J.depth),A)if(v.layerUpdates.size>0){const z=mc(J.width,J.height,v.format,v.type);for(const j of v.layerUpdates){const lt=J.data.subarray(j*z/J.data.BYTES_PER_ELEMENT,(j+1)*z/J.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,j,J.width,J.height,1,ht,wt,lt)}v.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,ht,wt,J.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,St,J.width,J.height,J.depth,0,ht,wt,J.data);else if(v.isData3DTexture)Rt?(Qt&&e.texStorage3D(n.TEXTURE_3D,nt,St,J.width,J.height,J.depth),A&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,ht,wt,J.data)):e.texImage3D(n.TEXTURE_3D,0,St,J.width,J.height,J.depth,0,ht,wt,J.data);else if(v.isFramebufferTexture){if(Qt)if(Rt)e.texStorage2D(n.TEXTURE_2D,nt,St,J.width,J.height);else{let z=J.width,j=J.height;for(let lt=0;lt<nt;lt++)e.texImage2D(n.TEXTURE_2D,lt,St,z,j,0,ht,wt,null),z>>=1,j>>=1}}else if(Vt.length>0){if(Rt&&Qt){const z=bt(Vt[0]);e.texStorage2D(n.TEXTURE_2D,nt,St,z.width,z.height)}for(let z=0,j=Vt.length;z<j;z++)dt=Vt[z],Rt?A&&e.texSubImage2D(n.TEXTURE_2D,z,0,0,ht,wt,dt):e.texImage2D(n.TEXTURE_2D,z,St,ht,wt,dt);v.generateMipmaps=!1}else if(Rt){if(Qt){const z=bt(J);e.texStorage2D(n.TEXTURE_2D,nt,St,z.width,z.height)}A&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,ht,wt,J)}else e.texImage2D(n.TEXTURE_2D,0,St,ht,wt,J);f(v)&&h(q),gt.__version=H.version,v.onUpdate&&v.onUpdate(v)}w.__version=v.version}function tt(w,v,I){if(v.image.length!==6)return;const q=Jt(w,v),K=v.source;e.bindTexture(n.TEXTURE_CUBE_MAP,w.__webglTexture,n.TEXTURE0+I);const H=i.get(K);if(K.version!==H.__version||q===!0){e.activeTexture(n.TEXTURE0+I);const gt=Ht.getPrimaries(Ht.workingColorSpace),st=v.colorSpace===qn?null:Ht.getPrimaries(v.colorSpace),ut=v.colorSpace===qn||gt===st?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ut);const kt=v.isCompressedTexture||v.image[0].isCompressedTexture,J=v.image[0]&&v.image[0].isDataTexture,ht=[];for(let j=0;j<6;j++)!kt&&!J?ht[j]=b(v.image[j],!0,r.maxCubemapSize):ht[j]=J?v.image[j].image:v.image[j],ht[j]=ne(v,ht[j]);const wt=ht[0],St=s.convert(v.format,v.colorSpace),dt=s.convert(v.type),Vt=S(v.internalFormat,St,dt,v.colorSpace),Rt=v.isVideoTexture!==!0,Qt=H.__version===void 0||q===!0,A=K.dataReady;let nt=B(v,wt);It(n.TEXTURE_CUBE_MAP,v);let z;if(kt){Rt&&Qt&&e.texStorage2D(n.TEXTURE_CUBE_MAP,nt,Vt,wt.width,wt.height);for(let j=0;j<6;j++){z=ht[j].mipmaps;for(let lt=0;lt<z.length;lt++){const ot=z[lt];v.format!==Xe?St!==null?Rt?A&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt,0,0,ot.width,ot.height,St,ot.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt,Vt,ot.width,ot.height,0,ot.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Rt?A&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt,0,0,ot.width,ot.height,St,dt,ot.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt,Vt,ot.width,ot.height,0,St,dt,ot.data)}}}else{if(z=v.mipmaps,Rt&&Qt){z.length>0&&nt++;const j=bt(ht[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,nt,Vt,j.width,j.height)}for(let j=0;j<6;j++)if(J){Rt?A&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,ht[j].width,ht[j].height,St,dt,ht[j].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Vt,ht[j].width,ht[j].height,0,St,dt,ht[j].data);for(let lt=0;lt<z.length;lt++){const Tt=z[lt].image[j].image;Rt?A&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt+1,0,0,Tt.width,Tt.height,St,dt,Tt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt+1,Vt,Tt.width,Tt.height,0,St,dt,Tt.data)}}else{Rt?A&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,St,dt,ht[j]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Vt,St,dt,ht[j]);for(let lt=0;lt<z.length;lt++){const ot=z[lt];Rt?A&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt+1,0,0,St,dt,ot.image[j]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,lt+1,Vt,St,dt,ot.image[j])}}}f(v)&&h(n.TEXTURE_CUBE_MAP),H.__version=K.version,v.onUpdate&&v.onUpdate(v)}w.__version=v.version}function vt(w,v,I,q,K,H){const gt=s.convert(I.format,I.colorSpace),st=s.convert(I.type),ut=S(I.internalFormat,gt,st,I.colorSpace),kt=i.get(v),J=i.get(I);if(J.__renderTarget=v,!kt.__hasExternalTextures){const ht=Math.max(1,v.width>>H),wt=Math.max(1,v.height>>H);K===n.TEXTURE_3D||K===n.TEXTURE_2D_ARRAY?e.texImage3D(K,H,ut,ht,wt,v.depth,0,gt,st,null):e.texImage2D(K,H,ut,ht,wt,0,gt,st,null)}e.bindFramebuffer(n.FRAMEBUFFER,w),Bt(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,q,K,J.__webglTexture,0,Ot(v)):(K===n.TEXTURE_2D||K>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,q,K,J.__webglTexture,H),e.bindFramebuffer(n.FRAMEBUFFER,null)}function rt(w,v,I){if(n.bindRenderbuffer(n.RENDERBUFFER,w),v.depthBuffer){const q=v.depthTexture,K=q&&q.isDepthTexture?q.type:null,H=E(v.stencilBuffer,K),gt=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,st=Ot(v);Bt(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,st,H,v.width,v.height):I?n.renderbufferStorageMultisample(n.RENDERBUFFER,st,H,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,H,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,gt,n.RENDERBUFFER,w)}else{const q=v.textures;for(let K=0;K<q.length;K++){const H=q[K],gt=s.convert(H.format,H.colorSpace),st=s.convert(H.type),ut=S(H.internalFormat,gt,st,H.colorSpace),kt=Ot(v);I&&Bt(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,kt,ut,v.width,v.height):Bt(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,kt,ut,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,ut,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Et(w,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(n.FRAMEBUFFER,w),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const q=i.get(v.depthTexture);q.__renderTarget=v,(!q.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),$(v.depthTexture,0);const K=q.__webglTexture,H=Ot(v);if(v.depthTexture.format===Wi)Bt(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,K,0,H):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,K,0);else if(v.depthTexture.format===Ji)Bt(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,K,0,H):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,K,0);else throw new Error("Unknown depthTexture format")}function Ct(w){const v=i.get(w),I=w.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==w.depthTexture){const q=w.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),q){const K=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,q.removeEventListener("dispose",K)};q.addEventListener("dispose",K),v.__depthDisposeCallback=K}v.__boundDepthTexture=q}if(w.depthTexture&&!v.__autoAllocateDepthBuffer){if(I)throw new Error("target.depthTexture not supported in Cube render targets");Et(v.__webglFramebuffer,w)}else if(I){v.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(e.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[q]),v.__webglDepthbuffer[q]===void 0)v.__webglDepthbuffer[q]=n.createRenderbuffer(),rt(v.__webglDepthbuffer[q],w,!1);else{const K=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,H=v.__webglDepthbuffer[q];n.bindRenderbuffer(n.RENDERBUFFER,H),n.framebufferRenderbuffer(n.FRAMEBUFFER,K,n.RENDERBUFFER,H)}}else if(e.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=n.createRenderbuffer(),rt(v.__webglDepthbuffer,w,!1);else{const q=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,K=v.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,K),n.framebufferRenderbuffer(n.FRAMEBUFFER,q,n.RENDERBUFFER,K)}e.bindFramebuffer(n.FRAMEBUFFER,null)}function Ft(w,v,I){const q=i.get(w);v!==void 0&&vt(q.__webglFramebuffer,w,w.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),I!==void 0&&Ct(w)}function oe(w){const v=w.texture,I=i.get(w),q=i.get(v);w.addEventListener("dispose",C);const K=w.textures,H=w.isWebGLCubeRenderTarget===!0,gt=K.length>1;if(gt||(q.__webglTexture===void 0&&(q.__webglTexture=n.createTexture()),q.__version=v.version,o.memory.textures++),H){I.__webglFramebuffer=[];for(let st=0;st<6;st++)if(v.mipmaps&&v.mipmaps.length>0){I.__webglFramebuffer[st]=[];for(let ut=0;ut<v.mipmaps.length;ut++)I.__webglFramebuffer[st][ut]=n.createFramebuffer()}else I.__webglFramebuffer[st]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){I.__webglFramebuffer=[];for(let st=0;st<v.mipmaps.length;st++)I.__webglFramebuffer[st]=n.createFramebuffer()}else I.__webglFramebuffer=n.createFramebuffer();if(gt)for(let st=0,ut=K.length;st<ut;st++){const kt=i.get(K[st]);kt.__webglTexture===void 0&&(kt.__webglTexture=n.createTexture(),o.memory.textures++)}if(w.samples>0&&Bt(w)===!1){I.__webglMultisampledFramebuffer=n.createFramebuffer(),I.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let st=0;st<K.length;st++){const ut=K[st];I.__webglColorRenderbuffer[st]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,I.__webglColorRenderbuffer[st]);const kt=s.convert(ut.format,ut.colorSpace),J=s.convert(ut.type),ht=S(ut.internalFormat,kt,J,ut.colorSpace,w.isXRRenderTarget===!0),wt=Ot(w);n.renderbufferStorageMultisample(n.RENDERBUFFER,wt,ht,w.width,w.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+st,n.RENDERBUFFER,I.__webglColorRenderbuffer[st])}n.bindRenderbuffer(n.RENDERBUFFER,null),w.depthBuffer&&(I.__webglDepthRenderbuffer=n.createRenderbuffer(),rt(I.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(H){e.bindTexture(n.TEXTURE_CUBE_MAP,q.__webglTexture),It(n.TEXTURE_CUBE_MAP,v);for(let st=0;st<6;st++)if(v.mipmaps&&v.mipmaps.length>0)for(let ut=0;ut<v.mipmaps.length;ut++)vt(I.__webglFramebuffer[st][ut],w,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+st,ut);else vt(I.__webglFramebuffer[st],w,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0);f(v)&&h(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(gt){for(let st=0,ut=K.length;st<ut;st++){const kt=K[st],J=i.get(kt);e.bindTexture(n.TEXTURE_2D,J.__webglTexture),It(n.TEXTURE_2D,kt),vt(I.__webglFramebuffer,w,kt,n.COLOR_ATTACHMENT0+st,n.TEXTURE_2D,0),f(kt)&&h(n.TEXTURE_2D)}e.unbindTexture()}else{let st=n.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(st=w.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(st,q.__webglTexture),It(st,v),v.mipmaps&&v.mipmaps.length>0)for(let ut=0;ut<v.mipmaps.length;ut++)vt(I.__webglFramebuffer[ut],w,v,n.COLOR_ATTACHMENT0,st,ut);else vt(I.__webglFramebuffer,w,v,n.COLOR_ATTACHMENT0,st,0);f(v)&&h(st),e.unbindTexture()}w.depthBuffer&&Ct(w)}function zt(w){const v=w.textures;for(let I=0,q=v.length;I<q;I++){const K=v[I];if(f(K)){const H=y(w),gt=i.get(K).__webglTexture;e.bindTexture(H,gt),h(H),e.unbindTexture()}}}const ue=[],D=[];function ze(w){if(w.samples>0){if(Bt(w)===!1){const v=w.textures,I=w.width,q=w.height;let K=n.COLOR_BUFFER_BIT;const H=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,gt=i.get(w),st=v.length>1;if(st)for(let ut=0;ut<v.length;ut++)e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ut,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ut,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,gt.__webglMultisampledFramebuffer),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,gt.__webglFramebuffer);for(let ut=0;ut<v.length;ut++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(K|=n.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(K|=n.STENCIL_BUFFER_BIT)),st){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,gt.__webglColorRenderbuffer[ut]);const kt=i.get(v[ut]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,kt,0)}n.blitFramebuffer(0,0,I,q,0,0,I,q,K,n.NEAREST),l===!0&&(ue.length=0,D.length=0,ue.push(n.COLOR_ATTACHMENT0+ut),w.depthBuffer&&w.resolveDepthBuffer===!1&&(ue.push(H),D.push(H),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,D)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ue))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),st)for(let ut=0;ut<v.length;ut++){e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ut,n.RENDERBUFFER,gt.__webglColorRenderbuffer[ut]);const kt=i.get(v[ut]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ut,n.TEXTURE_2D,kt,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,gt.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const v=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[v])}}}function Ot(w){return Math.min(r.maxSamples,w.samples)}function Bt(w){const v=i.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Mt(w){const v=o.render.frame;u.get(w)!==v&&(u.set(w,v),w.update())}function ne(w,v){const I=w.colorSpace,q=w.format,K=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||I!==nr&&I!==qn&&(Ht.getTransfer(I)===Kt?(q!==Xe||K!==ln)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",I)),v}function bt(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=G,this.setTexture2D=$,this.setTexture2DArray=X,this.setTexture3D=Z,this.setTextureCube=k,this.rebindTextures=Ft,this.setupRenderTarget=oe,this.updateRenderTargetMipmap=zt,this.updateMultisampleRenderTarget=ze,this.setupDepthRenderbuffer=Ct,this.setupFrameBufferTexture=vt,this.useMultisampledRTT=Bt}function y1(n,t){function e(i,r=qn){let s;const o=Ht.getTransfer(r);if(i===ln)return n.UNSIGNED_BYTE;if(i===La)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Da)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Zc)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===$c)return n.BYTE;if(i===Kc)return n.SHORT;if(i===Sr)return n.UNSIGNED_SHORT;if(i===Ra)return n.INT;if(i===gi)return n.UNSIGNED_INT;if(i===En)return n.FLOAT;if(i===er)return n.HALF_FLOAT;if(i===Jc)return n.ALPHA;if(i===Qc)return n.RGB;if(i===Xe)return n.RGBA;if(i===tu)return n.LUMINANCE;if(i===eu)return n.LUMINANCE_ALPHA;if(i===Wi)return n.DEPTH_COMPONENT;if(i===Ji)return n.DEPTH_STENCIL;if(i===nu)return n.RED;if(i===Ua)return n.RED_INTEGER;if(i===iu)return n.RG;if(i===Ia)return n.RG_INTEGER;if(i===Fa)return n.RGBA_INTEGER;if(i===_s||i===xs||i===bs||i===Ms)if(o===Kt)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===_s)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===xs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===bs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ms)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===_s)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===xs)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===bs)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ms)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===qo||i===jo||i===Yo||i===$o)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===qo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===jo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Yo)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===$o)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Ko||i===Zo||i===Jo)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Ko||i===Zo)return o===Kt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Jo)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Qo||i===ta||i===ea||i===na||i===ia||i===ra||i===sa||i===oa||i===aa||i===la||i===ca||i===ua||i===ha||i===da)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Qo)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ta)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===ea)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===na)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===ia)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===ra)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===sa)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===oa)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===aa)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===la)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ca)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===ua)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===ha)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===da)return o===Kt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ws||i===pa||i===fa)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(i===ws)return o===Kt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===pa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===fa)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===ru||i===ma||i===va||i===ga)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(i===ws)return s.COMPRESSED_RED_RGTC1_EXT;if(i===ma)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===va)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ga)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Zi?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}class C1 extends Qe{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class ms extends Oe{constructor(){super(),this.isGroup=!0,this.type="Group"}}const T1={type:"move"};class bo{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ms,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ms,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new O,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new O),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ms,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new O,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new O),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const i of t.hand.values())this._getHandJoint(e,i)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){o=!0;for(const b of t.hand.values()){const f=e.getJointPose(b,i),h=this._getHandJoint(c,b);f!==null&&(h.matrix.fromArray(f.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=f.radius),h.visible=f!==null}const u=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],p=u.position.distanceTo(d.position),m=.02,_=.005;c.inputState.pinching&&p>m+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&p<=m-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=e.getPose(t.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(T1)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const i=new ms;i.matrixAutoUpdate=!1,i.visible=!1,t.joints[e.jointName]=i,t.add(i)}return t.joints[e.jointName]}}const A1=`
void main() {
